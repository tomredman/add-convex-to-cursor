...
# Paths (modify these if Cursor is installed differently on your system)
DB_PATH="$HOME/.config/Cursor/User/globalStorage/state.vscdb"
SNIPPETS_DIR="$HOME/.config/Cursor/User/snippets"
CURSOR_EXECUTABLE="/usr/bin/cursor" # Adjust this path as needed
